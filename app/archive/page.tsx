...
export default function ArchivePage() {
  return (
    <>
      ...
      />
      <section className="section site-width"><p className="eyebrow">2026.09.17 新增收錄</p><h2>試作、田間與手作課程的新補充</h2><div className="usability-grid"><article><h3>賴永富居家試作</h3><p>精選 3 張照片與 2 段影片，呈現材料處理、部件與戶外試用。</p><Link href="/projects/gonggen#lai-yongfu-home-trial">閱讀試作紀錄 →</Link></article><article><h3>歷年黑豆種植與食農</h3><p>5 張照片，補充種植、課程、田間與產品舊影；年份待補。</p><Link href="/education#black-bean-history-supplement">查看黑豆紀錄 →</Link></article><article><h3>協會歷年課程｜日托手作紙</h3><p>王柏傑老師指導，蚵殼粉、小麥桿及日曆紙碎屑成為手作紙材料。</p><Link href="/archive/daycare-handmade-paper">閱讀課程舊影 →</Link></article></div></section>
